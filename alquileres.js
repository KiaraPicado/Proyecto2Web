...
const clientsAPI = 'http://localhost/Proyecto2/Controller/clientes.php';
const booksAPI = 'http://localhost/Proyecto2/Controller/libros.php';
const rentalsAPI = 'http://localhost/Proyecto2/Controller/alquileres.php';
